                ...
                <div class="row flex-wrap justify-content-center justify-content-lg-between align-items-lg-center">
                    <div class="col-12 col-lg-8 d-none d-md-flex flex-wrap justify-content-center justify-content-lg-start mb-3 mb-lg-0">
                        <div class="header-bar-email">
                            MAIL: <a href="#">bhashkar0l8@gmail.com</a>
                        </div><!-- .header-bar-email -->

                        <div class="header-bar-text">
                            <p>PHONE: <span>+919148842612</span></p>
                        </div><!-- .header-bar-text -->
                    </div><!-- .col -->
                        ...
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <footer class="entry-footer d-flex flex-wrap align-items-center mt-5">
                                    <a href="https://developer.paytm.com/" class="btn gradient-bg mr-2">Donate Now</a>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mt-5 mt-md-0">
                        <div class="foot-contact">
                            ...
                            <ul>
                                <li><i class="fa fa-phone"></i><span>+91 9148842612</span></li>
                            <li><i class="fa fa-envelope"></i><span>bhashkar@018@gmail.com</span></li>
                            <li><i class="fa fa-map-marker"></i><span>Sir mvit, Bangalore</span></li>
                            </ul>
                        </div><!-- .foot-contact -->
...
Copyright &copy; Bhashkar .<script>document.write(new Date().getFullYear());</script> All rights reserved </p>
